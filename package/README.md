...
The installable interface runs as static HTML, CSS, and JavaScript inside the host-controlled sandboxed iframe. It does not run package scripts, apply migrations, dynamically load TypeScript components, or write platform runtime files. The `Review package` action represents the platform inspection, preflight, and dry-run workflow.
